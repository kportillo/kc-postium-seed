...
export class PostService {
  ...
  getPosts(): Observable<Post[]> {
    ...
    |=========================================================================*/
    //Calcular la fecha actual en formato timestamp
    const fecha : number = Math.floor(Date.now());
    const options = {      
      params: new HttpParams()
        .set('_sort', 'publicationDate')
        .set('_order', 'desc')
        .set('publicationDate_lte', fecha.toString())
